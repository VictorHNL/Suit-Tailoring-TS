...
public final class CatalogDtos {
  ...
  public record Input(
      ...
      @Size(max = 150) String collectionName,
      @Size(max = 2000) String care,
      @NotNull Product.Audience audience,
      @NotNull Product.BodyPart bodyPart,
      ...
      @NotNull @Size(max = 10)
          List<
                  ...
                  @Pattern(regexp = "(?:https://[^\\s]+|/api/media/[a-f0-9-]+\\.(?:png|jpg))")
                  String>
              images,
  ...
  public record VariantView(UUID id, String sku, String size, String color, int stock) {
    public static VariantView of(Variant v) {
      return new VariantView(v.getId(), v.getSku(), v.getSize(), v.getColor(), v.getStock());
    }
  }
  ...
  public record View(
    ...
    public static View of(Product p, List<Variant> variants) {
      return new View(
          p.getId(),
          p.getVersion(),
          p.getName(),
